                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <a href="{{ route('Admins.backend.logout') }}" class="btn btn-default btn-flat" onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();">@lang('site.logout')</a>

                                <form id="logout-form" action="{{ route('Admins.backend.logout') }}" method="POST" style="display: none;">
                                    @csrf
                                </form>
...
{{--    @include('partials._errors')--}}
    ...
    @include('Admins::layouts.dashboard._aside')
